...
INSERT INTO survey(surveyno, surveytopic, startdate, enddate, yn, rdate, adminno)
VALUES (survey_seq.nextval, '설문조사', '2022-12-26', '2022-12-31', 'N', sysdate, 1);

INSERT INTO survey(surveyno, surveytopic, startdate, enddate, yn, rdate, adminno)
VALUES (survey_seq.nextval, '설문조사1', '2022-12-26', '2022-12-31', 'Y', sysdate, 1);

SELECT surveyno, surveyitemno, surveytopic,  surveyitem1, surveyitem2, surveyitem3, surveyitem4, surveyitem5,
                                surveyitem6, surveyitem7, startdate, enddate, yn, rdate, adminno
FROM survey
