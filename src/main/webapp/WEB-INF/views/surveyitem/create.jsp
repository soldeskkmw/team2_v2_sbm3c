...
<DIV class='title_line'>${surveyVO.surveytopic } > 글 등록</DIV>
...
<DIV class='content_body'>
  ...
  <FORM name='frm' method='POST' action='./create.do' enctype="multipart/form-data">
    ...
    <div>
       <label>항목 내용</label>
       <textarea name='surveyitem' required="required" class="form-control" rows="12" style='width: 100%;'></textarea>
    </div>
      
    <div class="content_body_bottom">
      <button type="submit" class="btn btn-secondary">등록</button>
      <button type="button" onclick="location.href='./list_by_surveyno.do?surveyno=${param.surveyno}'" class="btn btn-secondary">목록</button>
    </div>
