...
<DIV class='title_line'>설문조사 > [${surveyVO.surveytopic}] 삭제</DIV>
...
<DIV class='content_body'>
  <DIV id='panel_delete' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    ...
    <FORM name='frm_delete' id='frm_delete' method='POST' action='./read_delete.do'>
      ...
      <label>설문조사</label>: ${surveyVO.surveytopic } 
       
      <button type="submit" id='submit' class="btn btn-secondary">삭제</button>
      <button type="button" onclick="location.href='./list_all.do'" class="btn btn-secondary">취소</button>
    </FORM>
  </DIV>
