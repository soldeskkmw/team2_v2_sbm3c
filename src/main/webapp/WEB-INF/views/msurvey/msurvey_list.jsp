...
<DIV class='content_body'>
   ...
   <tbody>
    <c:forEach var="surveyVO" items="${survey_list }">
      ...
      <TR style="height: 40px;">
        ...
        <TD style='vertical-align: middle;'><div><a href="./survey_read.do?surveyno=${surveyno }">${surveytopic }</A></div></TD>
        <TD style='vertical-align: middle;'>
        <a href="./survey_read.do?surveyno=${surveyno }">
          <strong>
            <c:choose>
  ...
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    ...
    <FORM name='frm_create' id='frm_create' method='POST' action='./survey_create.do'>
      <label></label>
    <c:if test="${sessionScope.adminid != null }">
