...
<c:set var="surveyanswer1" value="${msurveyVO.surveyanswer1 }" />
<c:set var="surveyanswer2" value="${msurveyVO.surveyanswer1 }" />
<c:set var="surveyanswer3" value="${msurveyVO.surveyanswer1 }" />
<c:set var="surveyanswer4" value="${msurveyVO.surveyanswer1 }" />
<c:set var="surveyanswer5" value="${msurveyVO.surveyanswer1 }" />
<c:set var="surveyanswer6" value="${msurveyVO.surveyanswer1 }" />
<c:set var="etc" value="${msurveyVO.etc }" />
<c:set var="memberno" value="${msurveyVO.memberno }" />
