...
<c:import url="/menu/top.do" />
  ...
  <DIV class='content_body'>
    ...
    <DIV class='message'>
      <FORM name='frm' method='POST' action='./unregister_proc.do'>
        '${adminVO.adminname }(${adminVO.adminid })' 관리자를 탈퇴하면 복구 할 수 없습니다.<br><br>
        정말로 탈퇴하시겠습니까?<br><br>         
        <input type='hidden' name='adminno' value='${adminVO.adminno}'>
        <input type='hidden' name='admingrade' value=31> 
