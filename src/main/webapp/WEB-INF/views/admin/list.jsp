...
<c:import url="/menu/top.do" />
  ...
  <DIV class='content_body'>
    ...
    <TR>
      ...
      <TD class='td_basic' style="vertical-align:middle;">
        <A href="./passwd_update.do?adminno=${adminno}"><IMG src='/images/lock.png' title='패스워드 변경' class="icon"></A>
        <A href="./read.do?adminno=${adminno}"><IMG src='/images/file_rename.png' title='수정' class="icon"></A>
        <A href="./delete.do?adminno=${adminno}"><IMG src='/images/trash.png' title='삭제' class="icon"></A>
      </TD>
