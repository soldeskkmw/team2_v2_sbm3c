...
<script type="text/javascript">
  ...
  function send() {
    if ($('#new_memberpasswd').val() != $('#new_memberpasswd2').val()) {
      ...
      $('#btn_close').attr("data-focus", "new_memberpasswd"); // 모달창에서 닫기 버튼 클릭시 focus를 이동할 태그 설정
  ...
  <ASIDE class="aside_right">
    ...
    <FORM name='frm' id='frm' method='POST' action='./passwd_search_result.do'>
      ...
      <div class="form_input">
        ...
        <input type='password' class="form-control" name='new_memberpasswd' 
                  id='new_memberpasswd' value='' required="required" style='width: 70%;' placeholder="새로운 패스워드">
      </div>   
   
      <div class="form_input">
        <label>새로운 패스워드 확인</label>    
        <input type='password' class="form-control" name='new_memberpasswd2' 
                  id='new_memberpasswd2' value='' required="required" style='width: 70%;' placeholder="패스워드">
      </div>   
