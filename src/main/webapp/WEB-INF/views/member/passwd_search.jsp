  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do'>
    ...
    <div class="form_input">
      <input type='text' class="form-control" name='memberid' id='memberid' 
                value='' required="required" style='width: 30%;' placeholder="아이디">
    </div>   
    ...
    <div class="form_input">
      <input type='text' class="form-control" name='auth_no' id='auth_no' value=''  style='width: 30%;' placeholder="인증번호 8자리 숫자 입력">
    </div>
