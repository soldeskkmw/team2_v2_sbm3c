...
// sms이동  
function sms() {
     location.href="../sms/form_passwd.do";
}

// email이동  
function email() {
    location.href="../email/form_passwd.do";
}
...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line' style="font-size:1.5rem;">비밀번호 찾기</DIV>
  ...
  <FORM name='frm_passwd_search' id='frm_passwd_search'>

    <div class="form_input" style="padding-top:8px;">
       ※ 인증이 필요합니다
       <br><br>
