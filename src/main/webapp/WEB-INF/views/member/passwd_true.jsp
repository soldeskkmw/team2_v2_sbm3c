...
<script type="text/javascript">
  ...
  function send() {
    if ($('#memberpasswd').val() != $('#memberpasswd2').val()) {
      ...
      $('#btn_close').attr("data-focus", "memberpasswd"); // 모달창에서 닫기 버튼 클릭시 focus를 이동할 태그 설정
  ...
  <DIV class='content_body'>
    ...
    <input type='hidden' name='memberno' value='${memberno}'>     
      <div class="form_input">
        <label>현재 패스워드</label>    
        <input type='password' class="form-control" name='memberpasswd' 
                    id='memberpasswd' value='' required="required" style='width: 70%;' placeholder="현재 패스워드">
      </div>   
                      
      <div class="form_input">
        <label>현재 패스워드 확인</label>    
        <input type='password' class="form-control" name='memberpasswd2' 
                  id='memberpasswd2' value='' required="required" style='width: 70%;' placeholder="새로운 패스워드">
      </div>      
