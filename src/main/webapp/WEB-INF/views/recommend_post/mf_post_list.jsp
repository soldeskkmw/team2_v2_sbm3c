...
function send() {
  ...
  $.ajax({
    url: 'http://127.0.0.1:8000/recommend_post/mf_post', // form action
...
>>>>>>> ccf1856aa8c91cb2454ed2ec9c008f842127afa3
        ...
        tags += "post_word: " + row.post_word +"<br>";
        tags += "post_rating: " + row.post_rating + "</li>";
        tags += "</DIV>";
      }
      tags += "</DIV>";
  ...
  $('#panel').html("<img src='/recommend_post/images/ani04.gif' style='width: 10%;'>"); // static
