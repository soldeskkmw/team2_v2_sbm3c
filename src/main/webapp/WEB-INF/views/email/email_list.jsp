...
<c:import url="/menu/top.do" />
  ...
  <DIV class='content_body'>
    ...
    <c:forEach var="emailVO" items="${email_list }">
      <c:set var="search" value ="${emailVO.search}" />
      <c:set var="emailno" value ="${emailVO.emailno}" />
      <c:set var="memberno" value ="${emailVO.memberno}" />
    ...
    <TR>
      ...
      <TD class='td_basic' style="vertical-align:middle;">${emailno}</TD>
      <TD class='td_basic' style="vertical-align:middle;">${memberno}</TD>
      <TD class='td_basic' style="vertical-align:middle;">${ip}</TD>
      <TD class='td_basic' style="vertical-align:middle;">${receiver}</TD>
      ...
      <A href="./delete.do?emailno=${emailno}"><IMG src='/images/trash.png' title='삭제' class="icon"></A>
