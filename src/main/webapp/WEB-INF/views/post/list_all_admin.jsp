...
<DIV class='title_line'>
  <A href="./list_all_admin.do" class='title_link'>전체 글 목록</A>
</DIV>
...
<!--     <thead>
    ...
    <%-- table 내용 --%>
    <tbody>
      <c:forEach var="adminPostVO" items="${list }">
        <c:set var="postno" value="${adminPostVO.postno }" />
        <c:set var="adminno" value="${adminPostVO.adminno }" />
        <c:set var="adminname" value="${adminPostVO.adminname }" />
        <c:set var="posttitle" value="${adminPostVO.posttitle }" />
				<c:set var="postcontent" value="${adminPostVO.poscontent }" />
				<c:set var="postword" value="${adminPostVO.postword }" />
				<c:set var="rdate" value="${adminPostVO.rdate }" />
				<c:set var="udate" value="${adminPostVO.udate }" />
				<c:set var="postthumb1" value="${adminPostVO.postthumb1 }" />
