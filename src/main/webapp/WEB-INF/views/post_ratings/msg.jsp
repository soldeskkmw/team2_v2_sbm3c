...
<c:set var="postword" value="${param.postword }" />
  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        ...
        <button type='button' onclick="location.href='../post/read.do?postno=${postno }&cateno=${cateno}&postword=${postword}'" class="btn btn-primary">목록</button>
      </LI>
    </UL>
  </fieldset>
</DIV>
