  ...
  <DIV class='title_line' style="font-size:1.5rem;">SMS 인증받는 번호 입력</DIV>
    ...
    <DIV class='content_body'>
      <DIV style='width: 60%; margin: 0px auto;'>
           <form name="smsForm" id="smsForm" action="./admin_proc.do" method="post">
              ...
              <input type="hidden" name="returnurl" id="returnurl" maxlength="64" value="./admin_proc_next.do" size="80">
