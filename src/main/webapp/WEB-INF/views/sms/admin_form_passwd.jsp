...
function setFocus() {  // focus 이동
  ...
  function send() { // 회원 가입 처리
   ...
   /*   // 패스워드를 정상적으로 2번 입력했는지 확인
    ...
    $('#smsForm_passwd').submit(); // required="required" 작동 안됨.
  }  
...
<c:import url="/menu/top.do" />
  ...
  <DIV class='title_line' style="font-size:1.5rem;">SMS 인증받는 번호 입력</DIV>
    
    <DIV class='content_body'>
      <DIV style='width: 60%; margin: 0px auto;'>
           <form name="smsForm_passwd" id="smsForm_passwd" action="./admin_proc_passwd.do" method="post">
             ...
             <!-- 정상적으로 문자가 전송되고 나서 이동할 주소 -->
              <input type="hidden" name="returnurl" id="returnurl" maxlength="64" value="./admin_proc_passwd_next.do" size="80">
              ...
              <br>
                ...
                <label>아 이 디 &nbsp;&nbsp;&nbsp;</label> 
                <input type="text" name="memberid" id="memberid" value='' required="required">
                </div>
                받는 번호 &nbsp;&nbsp;<input type="text" name="rphone" id="rphone" value='' style="margin-right:7px; margin-top:8px; margin-bottom:7px;"> 예) 011-0112-1112 , '-' 포함해서 입력. <br>
...
=======
              <input type="hidden" name="sphone2" value="2722"> <!-- 전화번호 둘째자리 2722-->
