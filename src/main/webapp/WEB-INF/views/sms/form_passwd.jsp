  ...
  <DIV class='title_line' style="font-size:1.5rem;">SMS 인증받는 번호 입력</DIV>
    ...
    <DIV class='content_body'>
      <DIV style='width: 60%; margin: 0px auto;'>
           <form name="smsForm_passwd" id="smsForm_passwd" action="./proc_passwd.do" method="post">
             ...
             <!-- 정상적으로 문자가 전송되고 나서 이동할 주소 -->
              <input type="hidden" name="returnurl" id="returnurl" maxlength="64" value="./proc_passwd_next.do" size="80">
