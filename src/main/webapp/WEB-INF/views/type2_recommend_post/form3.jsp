...
<body>
<DIV class="container">
    <H3 style=' margin-top: 10px;'>3/6 단계입니다.</H3>
    <DIV id='panel' style='display: none; margin: 10px auto; width: 90%;'></DIV>
    <form id='frm' name='frm' action='/type2_recommend_post/form4.do' method='GET'>
    ...
    <input type='hidden' name='step2' value='${param.step2 }'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/type2_recommend_post/images/v31.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_post/images/v32.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
            ...
            <TR>
                <TD class='td_image'>
                    <img id='img4' src="/type2_recommend_post/images/v34.jpeg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_post/images/v35.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_post/images/v36.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
