...
<body>
<DIV class="container">
    <H3 style=' margin-top: 10px;'>4/6 단계입니다.</H3>
    <DIV id='panel' style='display: none; margin: 10px auto; width: 90%;'></DIV>
    <form id='frm' name='frm' action='/type2_recommend_post/form5.do' method='GET'>
    ...
    <input type='hidden' name='step3' value='${param.step3 }'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/type2_recommend_post/images/v41.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_post/images/v42.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/type2_recommend_post/images/v43.png" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
            ...
            <TR>
                <TD class='td_image'>
                    <img id='img4' src="/type2_recommend_post/images/v44.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_post/images/v45.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_post/images/v46.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
