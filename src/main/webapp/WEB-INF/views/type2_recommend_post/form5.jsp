...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/type2_recommend_post/form6.do' method='GET'>
    ...
    <input type='hidden' name='step4' value='${param.step4 }'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/type2_recommend_post/images/v51.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/type2_recommend_post/images/v52.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/type2_recommend_post/images/v53.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
            ...
            <TR>
                <TD class='td_image'>
                    <img id='img4' src="/type2_recommend_post/images/v54.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/type2_recommend_post/images/v55.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img6' src="/type2_recommend_post/images/v56.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
