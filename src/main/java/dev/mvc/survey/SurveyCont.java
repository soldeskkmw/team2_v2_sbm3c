...
//    spring.mvc.view.suffix=.jsp
  ...
  public ModelAndView create(SurveyVO surveyVO, HttpSession session) {
    
    ModelAndView mav = new ModelAndView();
    
    int adminno = (int) session.getAttribute("adminno");
    surveyVO.setAdminno(adminno);
...
//      mav.setViewName("/survey/msg"); // /webapp/WEB-INF/views/survey/msg.jsp      
  ...
  public ModelAndView list_all() {
    ...
    ArrayList<SurveyVO> list_all = surveyProc.list_all();
  ...
  /**
   * 모든 레코드 목록 조회, http://localhost:9093/survey/list_all.do
   * @return
   */
  @RequestMapping(value="/survey/list_all.do", method=RequestMethod.POST)
  public ModelAndView survey_list_proc() {
    ModelAndView mav = new ModelAndView();
  ...
  public ModelAndView read_update(int surveyno) {
    ...
    ArrayList<SurveyVO> list_all = this.surveyProc.list_all();
    mav.addObject("list_all", list_all);
