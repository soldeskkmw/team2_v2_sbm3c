  ...
  */
  ...
  public ModelAndView create(MemberVO memberVO){
    ...
    if (cnt == 1) {
      ...
      mav.addObject("membername", memberVO.getMembername());  // 홍길동님(user4) 회원 가입을 축하합니다.
...
//  }
  ...
  public ModelAndView update(HttpSession session, MemberVO memberVO){
    ...
    if (cnt == 1) {
      ...
      mav.addObject("membername", memberVO.getMembername());  // 홍길동님(user4) 회원 정보를 변경했습니다.
      mav.addObject("memberid", memberVO.getMemberid());
    } else {
...
//  }
  ...
  */
  ...
  public ModelAndView id_search(){
    ...
    mav.setViewName("/member/id_search"); // id_search.jsp
  ...
  public ModelAndView id_search_result(){
    ModelAndView mav = new ModelAndView();
    
    mav.setViewName("/member/id_search_result"); // id_search.jsp
  ...
  public ModelAndView passwd_search(){
    ...
    mav.setViewName("/member/passwd_search"); // passwd_search.jsp
